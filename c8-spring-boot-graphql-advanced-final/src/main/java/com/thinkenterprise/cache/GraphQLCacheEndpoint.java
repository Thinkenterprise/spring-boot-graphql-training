...
@Component
@Endpoint(id = "graphqlCache")
public class GraphQLCacheEndpoint {

  @Autowired
  private DataLoaderOptions dataLoaderOptions;

  @ReadOperation
  public Statistics getStatistics() {
    return dataLoaderOptions.getStatisticsCollector().getStatistics();
  }
}
